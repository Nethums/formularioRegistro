...
<form action="../libs/registroProcesar.php" method="post" enctype="multipart/form-data">
    ...
    <textarea name="biografia" rows="5" cols="50" placeholder="Escriba aquí cualquier otra cosa relacionada contigo..." ></textarea>
